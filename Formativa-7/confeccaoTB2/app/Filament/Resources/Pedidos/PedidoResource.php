...
class PedidoResource extends Resource
{
    ...
    public static function canAccess(): bool {
        return (auth()->user()?->hasRole('Admin') ?? False) || (auth()->user()?->hasRole('Vendedor') ?? False);
    }

    protected static ?string $navigationLabel = 'Gerenciar Pedidos';
    protected static ?string $modelLabel = 'Cadastrar Pedido';
